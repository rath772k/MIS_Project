...
class Input extends Element {
	...
	/*edit made by Bharath Raj S for min, max and step attributes*/
	function min($min = ''){
		if($min != ''){
...
class Option extends Element {
	...
	function show() {
		...
		/*edit made by Bharath Raj S to include empty strings as values*/
		if($this->value){
			echo '<option '.$this->_parse_attributes().'>'.$this->text.'</option>';
		}
		else{
			echo '<option '.$this->_parse_attributes().' value=""'.'>'.$this->text.'</option>';
		}
	}
}
